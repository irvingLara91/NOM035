                    ...
                    question.tipo === 'sino' ?
                        ...
                        <Button size={'lg'}
                            /*Cambiar colores del botón */
                                _light={{borderColor:app.color, borderWidth:2,bg: app.fontColor, _text: {color: app.color}}}
...

            {
                question.tipo === '4asc' || question.tipo === '4desc' ?
                    <VStack style={{paddingLeft: 30, paddingRight: 30}}>
                        ...
                        <Button size={'lg'}     _light={{borderColor:app.color, borderWidth:2,bg: app.fontColor, _text: {color: app.color}}}
                                _pressed={{borderColor:app.secondaryColor, borderWidth:0,bg: app.secondaryColor, _text: {color: app.color}}}
                                isLoading={loading}
                                style={{marginBottom: 20, width: '100%'}}
