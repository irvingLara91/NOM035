...
const SectionComponent = ({navigation, index=0, vref=null, encuesta=null, numEncuesta=1, nom035, responseQuestion, currentAssessment=1}) => {
    ...
    return (
        <Box style={{width:'100%'}}>
                ...
                <QuestionComponent
                    ...
                    question={encuesta.preguntas[currentQuestion]}
                    title={encuesta.preguntas[currentQuestion].pregunta}
